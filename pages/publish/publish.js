...
    auto_height:true,          //高度自适应
    ...
    //活动标签
    div_active:[
      {id:1,  name:"宣讲会",  bg_color:"#ffffff",selected: false,name_eng:"宣讲会"},
      {id:2,  name:"比赛",  bg_color:"#ffffff",selected: false,name_eng:"比赛"},
      {id:3,  name:"志愿活动",  bg_color:"#ffffff",selected: false,name_eng:"志愿活动"},
      {id:4,  name:"讲座", bg_color:"#ffffff",selected: false,name_eng:"讲座"},
      {id:5,  name:"电影节", bg_color:"#fffffff",selected: false,name_eng:"电影节"},
      {id:6,  name:"娱乐活动", bg_color:"#ffffff",selected: false,name_eng:"娱乐活动"},
      {id:7,  name:"校级",  bg_color:"#ffffff",selected: false,name_eng:"校级"},
      {id:8,  name:"院级", bg_color:"#ffffff",selected: false,name_eng:"院级"},
      {id:9,  name:"综测加分", bg_color:"#ffffff",selected: false,name_eng:"综测加分"},
      {id:10, name:"志愿时", bg_color:"#ffffff",selected: false,name_eng:"志愿时"},
      {id:11, name:"其他", bg_color:"#ffffff",selected: false,name_eng:"其他"},
    ],
...
//活动标签
  hocol: function (res) {
    ...
    console.log(!this.data.div_active[res.currentTarget.dataset.index].selected);
    this.setData({
      [string]: !this.data.div_active[res.currentTarget.dataset.index].selected
    })
    let detailValue = this.data.div_active.filter(item => {return item.selected == true}).map(item =>{return item.name_eng})
